...
(function(name) {
    ...
    var get_methods = 'stream userinfo current_user get_message validate get_following get_follower recommend_user get_lists get_list_info get_list_users search'.split(' ');
